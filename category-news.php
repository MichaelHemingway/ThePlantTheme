            ...
            <article class="flex-item has-border three-wide">
                <div class="card-wrapper">
                    ...
                    <ul class="u-list-none">
                        <li>News Editor <a href="mailto:news@theplantnewspaper.com">Sam Dagres</a></li>
                        <li>News Editor <a href="mailto:news@theplantnewspaper.com">Camron Heshmati Calderón</a></li>
                    </ul>
                    <hr />
