            ...
            <article class="flex-item has-border three-wide">
                <div class="card-wrapper">
                    ...
                    <ul class="u-list-none">
                        <li>Curiosities Editor <a href="mailto:curiosities@theplantnewspaper.com">Gabrielle Drummond-Dupuis</a></li>
                        <li>Horoscopes Guy <a href="mailto:mike@theplantnewspaper.com">Michael Hemingway</a></li>
                    </ul>
                    <hr />
